...
print("")
print("\033[1;36m🌐𝗜𝗣: CANADA [🇨🇦]")
print("")
print("🔖DIRECCIÓN 1: 181 Wellington St W")
print("🔖DIRECCIÓN 2: Avenue Road")
print("🔖ZIP CODE: A1A1A1")
print("🔖CITY: Toronto")
print("🔖STATE: Ontario")
print("🔖TLF: +1 416392xxxx")
print("")
