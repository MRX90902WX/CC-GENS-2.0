...
system("sleep 1")
print("")
print(" \033[1;31m-----> \033[1;34mBIN 417849 \033[1;31m<------")
system("sleep 2")
...
print("")
print("\033[1;36m🌐𝗜𝗣: MEXICO [🇦🇱]")
print("")
print("🔖DIRECCIÓN POSTAL: Proton 5")
print("🔖DEPARTAMENTO: Parque Industrial Naucalpan")
print("🔖CIUDAD: Naucalpan de Juarez")
print("🔖ESTADO: Mexico")
print("🔖ZIP CODE: 53489")
print("🔖PHONE: 01 55 5576 xxxx")
print("")

num = input("Desea generar el Tlf (y/n): ")

if num == "y":
   system("python num4.py")
else:
   exit()
